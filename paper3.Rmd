...
X_train <- train_set %>% 
  dplyr::select(Scenicness = Scenicness.median_of_bayescore,
...
```{python plot}
X =  r.landmap.loc[:, ['Scenicness.median_of_bayescore', 'Wildness.median', 'x', 'y']]
# -- play shap
explainer = shap.TreeExplainer(model)
# X = landmap.loc[:, ['UID', 'Scenicness.median_of_bayescore', 'Wildness.median', 'x', 'y']]
...
# In the case of matplotlib version 3.5 above, the adjustment of colorbar legend was referred to https://github.com/slundberg/shap/issues/2493
# summary plot for "CLASS 0" (Low scenic quality) 
shap.summary_plot(shap_values[0],
                  X_train.values,
                  feature_names = ['Scenicness', 'Wildness', 'x_coord', 'y_coord'], #X_train.columns,
                  show = False,
...
```{python}
# landmap = r.landmap
X_vars = ['Scenicness','Wildness', 'x', 'y']
