...
# https://notebooks.githubusercontent.com/view/ipynb?browser=chrome&color_mode=auto&commit=daa2504c337a74778632d44834209425cb6d357f&device=unknown&enc_url=&logged_in=false&nwo=MiladShahidi%2FFraud-Detection-XGBoost&path=XGBoost_Fraud_Detection.ipynb&platform=android&repository_id=152300978&repository_type=Repository&version=98
def objective(params, X = X_train, y = y_train, X_early_stop = 100, y_early_stop = 100, n_folds = 10):

    # pos_count = y_train.sum()
    # neg_count = len(y_train) - pos_count
    # imbalance_ratio = neg_count / pos_count
    
    xgb_clf = xgb.Classifier(**params, n_estimators = 2000, n_jobs = 1)
    ...
    cv_score = np.mean(cohen_kappa_score(xgb_clf,
                                         X_train, 
                                         y_train, 
                                         cv = n_folds, 
...
#### 3. Optimization algorithm (Tree Parzen Estimator, tpe)
...
```{python}
def tune_xgb(param_space, X_train, y_train, X_early_stop = 100, y_early_stop = 100, n_iter = 100):    
...
```{python}
tune_xgb(param_space, X_train, y_train, 100, 100, 100)
```
...
Tuning hyper-parameters of the XGBoost classifier using Bayesian Optimization
...
if __name__ == "__main__":    
  ...
  # Learning Task Parameters  
    ...
    param_space = {
      ...
      from hyperopt.pyll.stochastic import sample
space = {'subsample': hp.uniform('subsample', 0.25, 1)}
print(sample(space))
